...
var ContactDetailsComponent = /** @class */ (function () {
    ...
    ContactDetailsComponent.prototype.createContact = function (contact) {
        var _this = this;
        this.contactService.createStock(contact).then(function (newContact) {
            _this.createHandler(newContact);
        });
    };
    ContactDetailsComponent.prototype.updateContact = function (contact) {
        var _this = this;
        this.contactService.updateStock(contact).then(function (updatedContact) {
            _this.updateHandler(updatedContact);
        });
    };
    ContactDetailsComponent.prototype.deleteContact = function (contactId) {
        var _this = this;
        this.contactService.deleteStock(contactId).then(function (deletedContactId) {
            _this.deleteHandler(deletedContactId);
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _contact__WEBPACK_IMPORTED_MODULE_1__["Stock"])
...
var ContactListComponent = /** @class */ (function () {
    ...
    ContactListComponent.prototype.ngOnInit = function () {
        ...
        this.client = mqtt__WEBPACK_IMPORTED_MODULE_2__["connect"]('mqtt://shakeandbake.adamos-dev.com:1883', {
            username: 'shakeandbake/info@ilkohoffmann.com',
            password: 'nNFh8APNcMm8',
            clientId: 'node-client-stock',
        });
        this.client.on('connect', function () {
            ...
            // configure broker
            var connect = '100,node-client-stock,c8y_MQTTdevice';
            var interval = '117,1';
            var enableCommands = '114,c8y_Command,c8y_Configuration';
            _this.client.publish('s/us', connect);
            _this.client.publish('s/us', interval);
            _this.client.publish('s/us', enableCommands);
            // listen to topic
            _this.client.subscribe('s/ds');
        });
        this.client.on('message', function (topic, message) {
            switch (topic) {
            }
            // tslint:disable-next-line:no-console
            console.log('No handler for topic %s with message %m', topic, message.toString());
        });
    };
...
var ContactService = /** @class */ (function () {
    function ContactService(http) {
        this.http = http;
        this.contactsUrl = '/api/stocks';
    }
    // get("/api/stocks")
    ContactService.prototype.getStocks = function () {
    ...
    // post("/api/stocks")
    ContactService.prototype.createStock = function (newContact) {
    ...
    ContactService.prototype.deleteStock = function (delContactId) {
    ...
    // put("/api/stocks/:id")
    ContactService.prototype.updateStock = function (putContact) {
...
module.exports = __webpack_require__(/*! /Users/ilkohoffmann/Entwicklung/hackathon/mean-contactlist-angular2/src/main.ts */"./src/main.ts");
